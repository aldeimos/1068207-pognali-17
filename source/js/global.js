...
var headerBackground = document.querySelector(".page-header--background");
...
navToggle.addEventListener("click", function () {
  if (mainNav.classList.contains("main-nav__toggle-closed") && navToggle.classList.contains(
    ...
    headerBackground.classList.add("page-header--background-white");
    ...
    headerBackground.classList.remove("page-header--background-white");
    headerLogoWhite.classList.add("page-header__picture--opener");
